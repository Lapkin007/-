...
import com.cinema.wasai.mapper.WorkerMapper;
...
public class WorkerServiceImpl implements WorkerService{
	...
	@Override
	public List<Worker> selectAllAvalibaleWorkers() {
		log.info("通过主键查询Worker信息:selectAllAvalibaleWorkers ");
		return workerMapper.getAllAvaliableWorkers();
	}
