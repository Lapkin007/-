...
import com.cinema.wasai.mapper.LeavingMessageMapper;
...
public class LeavingMessageServiceImpl implements LeavingMessageService{
	...
	public List<LeavingMessage> selectAllLeavingMessagesAndUser() {
		log.info("通过主键查询LeavingMessage信息:selectAllLeavingMessagesAndUser() ");
		return leavingMessageMapper.selectAllLeavingMessagesAndUser();
	}
