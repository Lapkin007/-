...
import com.cinema.wasai.model.entiy.Arrangement;
...
import com.cinema.wasai.mapper.ArrangementMapper;
...
public class ArrangementServiceImpl implements ArrangementService{
	...
	@Override
	public List<Arrangement> selectByFid(Integer fid) {
		log.info("通过主键查询Arrangement信息:selectByFid() ");
		return arrangementMapper.selectByFid(fid);
	}
