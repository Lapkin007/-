...
import com.cinema.wasai.mapper.FilmMapper;
...
public class FilmServiceImpl implements FilmService{
	...
	//查询（热门榜单）
	@Override
	public List<Film> selectAllHotRanks(Integer hot) {
		log.info("通过hot查询Rank信息:selectAllHotRanks ");
		return filmMapper.selectAllHotRanks(hot);
	}
