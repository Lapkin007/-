package com.cinema.wasai.advice;



import com.cinema.wasai.annotation.DisableBaseResponse;
import com.cinema.wasai.annotation.DisableBaseResponse;
 ...
 * 不做json的封装，还是要返回json
 */
@RestControllerAdvice(basePackages = "com.cinema.wasai.controller")//这里是确定扫描哪个基础包下的类的方法，
